...
public class DateUtilTests {
	...
	public void itShouldGive0Minute() throws ParseException {
		...
		assertEquals(0, DateUtil.differenceInMinutes(before, after));
	}
	...
	public void itShouldGive1Minute() throws ParseException {
		...
		assertEquals(1, DateUtil.differenceInMinutes(before, after));
	}
	...
	public void itShouldGive30Minutes() throws ParseException {
		...
		assertEquals(30, DateUtil.differenceInMinutes(before, after));
	}
	...
	public void itShouldGive45Minutes() throws ParseException {
		...
		assertEquals(45, DateUtil.differenceInMinutes(before, after));
	}
	...
	public void itShouldGive2881Minutes() throws ParseException {
		...
		assertEquals(2881, DateUtil.differenceInMinutes(before, after));
	}
